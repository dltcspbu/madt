...
var jgraph = (function () {
    ...
    return {
        ...
        create: function (selector, options) {
            ...
            this.boxGeometry = new THREE.BoxGeometry(this.nodeSize * 1.3, this.nodeSize * 1.3, this.nodeSize * 1.3);
         ...
         */
        draw: function (graph) {
            var material, geom, mesh, arrow, mag, self, map, n1, n2, sqrt;
            self = this;
            map = {};
            this.current = graph;
            ...
            $.each(graph.nodes, function (k, node) {
                ...
                geom = node.image != 'madt/quagga' ? self.sphereGeometry : self.boxGeometry;
        ...
        onNodeClick: function (callback) {
            ...
            this.$s.click(function (event) {
                ...
                vector = new THREE.Vector3((event.clientX / window.innerWidth) * 2 - 1,
                    -(event.clientY / self.$s.height()) * 2 + 1, 0.5);
